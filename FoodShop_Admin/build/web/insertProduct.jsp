            ...
            <div class="float-right">
                ...
                <div>
                    ...
                    <div style="display:flex;">
                        <img src="${requestScope.product.getImagepath()}" style="width:400px; height: 400px; margin-top: 10%; border: 4px solid #3366CC; margin-left: 5%;">
                            ...
                            <div>
                                ...
                                <div class="input">
                                    <tr>
                                        ...
                                        <td><textarea name="description" rows="20" cols="50" placeholder="Description" class="<c:if test="${requestScope.messageDes != null}">anno-red</c:if>"> ${requestScope.description}</textarea>
                                 </td>
                                    </tr>
                                </div>
